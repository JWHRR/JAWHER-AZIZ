...
-- user_roles : seuls admins g̬rent ; chacun peut lire ses r̫les
...
-- dortoirs : tout authentifi̩ peut lire ; admin g̬re
...
-- cr̩ateur voit ses propres ; surveillant peut cr̩er.
...
-- activity_logs : admin lit tout ; chacun peut ins̩rer ses propres logs
...
-- =========================================================
-- RECLAMATIONS - correctif consolide (idempotent)
-- Doit rester aligne avec
-- supabase/migrations/20260918000000_fix_reclamations.sql
-- =========================================================
...
-- SELECT : tout utilisateur authentifie voit toutes les reclamations
...
-- DELETE : admin, ou l'auteur de la reclamation
...
-- PROFILS : lecture par tout utilisateur authentifie (annuaire interne)
